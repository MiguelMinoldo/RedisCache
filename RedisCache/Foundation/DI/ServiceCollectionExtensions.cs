...
namespace Foundation.DI
{
    public static class ServiceCollectionExtensions
    {
        ...
        {
            var controllers = GetTypesImplementing(typeof(SitecoreController), assemblies, classFilters).ToList();

            controllers.AddRange(GetTypesImplementing(typeof(Controller), assemblies, classFilters));
